<template>
  <div class="flex justify-start my-2">
    ...
    <div class="overflow-hidden pl-2 w-full">
      ...
      <p click="text-[#009A66] text-xs font-semibold pt-1">Free 11-days delivery over $ 8.28</p>
      <p click="text-[#009A66] text-xs font-semibold pt-1">Free Shipping</p>
...
const removeFromCart = () => {
  userStore.cart.forEach((product, index) => {
    if (product.id === product.value.id) {
